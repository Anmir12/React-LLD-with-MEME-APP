...
- ✅ Accordion (FAQ) - Managed "Single-Open" logic by lifting state up into Context.
...
- **Mar 1-2:** **LLD Pattern: Accordion & Lifted State:**
  - Built a data-driven Accordion component.
  - Centralized toggle logic in LangContext to ensure a Single-Open policy (opening one item closes others).
  - Demonstrated the "Controlled Component" pattern by passing openItem state down to children.
