...
* **Feb 26-27:** **Global State & i18n:** Implemented `LangContext` and a dynamic `LangConfig` to support English, Telugu, and Hindi across the entire app. Refactored architecture to "One Route Per LLD Question."
